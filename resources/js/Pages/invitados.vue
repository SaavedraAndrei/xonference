<template>
  <div>
    <header class="site-header">
      <div class="hero">
        <div class="contenido-header" style="padding-top: 40px;">
          ...
          <div class="informacion-evento">
            <div class="clearfix">
              <p class="fecha">
                <i class="fa fa-calendar" aria-hidden="true"></i> 01-02 Julio
              </p>
              <p class="ciudad">
                <i class="fa fa-map-marker" aria-hidden="true"></i> Huancayo,
                Perú
              </p>
            </div>
            ...
            <p class="slogan">
              Los mejores congresos de <span>Ingeniería</span>
            </p>
          </div>
          <!--.informacion-evento-->
        </div>
      ...
      <ul class="lista-invitados clearfix">
        ...
        <div style="display:none;">
          <div class="invitado-info" id="invitado1">
            ...
            <p>
              Praesent rutrum efficitur pharetra. Vivamus scelerisque pretium
              velit, id tempor turpis pulvinar et. Ut bibendum finibus massa non
              molestie.
            </p>
          </div>
        </div>
        ...
        <div style="display:none;">
          <div class="invitado-info" id="invitado2">
            ...
            <p>
              Curabitur urna metus, placerat gravida lacus ut, lacinia congue
              orci. Maecenas luctus mi at ex blandit vehicula. Morbi porttitor
              tempus euismod.
            </p>
          </div>
        </div>
        ...
        <div style="display:none;">
          <div class="invitado-info" id="invitado3">
            ...
            <p>
              placerat gravida lacus ut, lacinia congue orci. Maecenas luctus mi
              at ex blandit vehicula. Morbi porttitor tempus euismod.
            </p>
          </div>
        </div>
        ...
        <div style="display:none;">
          <div class="invitado-info" id="invitado4">
            ...
            <p>
              Praesent rutrum efficitur pharetra. Vivamus scelerisque pretium
              velit, id tempor turpis pulvinar et. Ut bibendum finibus
            </p>
          </div>
        </div>
        ...
        <div style="display:none;">
          <div class="invitado-info" id="invitado6">
            ...
            <p>
              Praesent rutrum efficitur pharetra. Vivamus scelerisque pretium
              velit, id tempor turpis pulvinar et. Ut bibendum finibus massa non
              molestie. Curabitur urna metus, placerat gravida lacus ut, lacinia
              congue orci. Maecenas luctus mi at ex blandit vehicula. Morbi
